...
class XMLValidationError(ValidationError):
    ...
    def __init__(self, field: str = None, message: str = None, xpath: str = None, details: str = None):
        self.xpath = xpath
...
class XMLSchemaError(XMLValidationError):
    ...
    def __init__(self, schema_name: str, details: str = None):
        super().__init__(message=f"Does not conform to schema: {schema_name}", details=details)
...
class XMLInvalidValueError(XMLValidationError):
    ...
    def __init__(self, field: str, details: str = None, xpath: str = None):
        super().__init__(field=field, message="Invalid value", xpath=xpath, details=details)
