...
"""
Module for converting data types for DynamoDB.
This module provides helper functions to convert float values to Decimal objects
and date objects to ISO formatted strings, as required by DynamoDB.
"""
